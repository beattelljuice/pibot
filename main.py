...
def main() -> None:
    ...
    try:
        ...
        camera = CameraController(
            ...
            output_width=camera_config.get("output_width", "auto"),
            output_height=camera_config.get("output_height", "auto"),
            output_resize_mode=camera_config.get("output_resize_mode", "fit"),
        ...
        ollama = OllamaClient(
            ...
            two_stage=ollama_config.get("two_stage", True),
            translator_model=ollama_config.get("translator_model"),
            translator_timeout_ms=ollama_config.get("translator_timeout_ms"),
            expression_layer=ollama_config.get("expression_layer", False),
            expression_model=ollama_config.get("expression_model"),
            expression_timeout_ms=ollama_config.get("expression_timeout_ms"),
            persona=ollama_config.get("persona"),
